...
public class GlossaryItem1302204057 {
    public static void ReadJSON() {
        try {
            Object obj = new JSONParser().parse(new FileReader("D:\\Kuliah\\Semester 4\\Konstruksi Perangkat Lunak\\Jurnal\\JURNAL-MOD-6-KPL\\src\\jurnal6_3_1302204057.json"));
    ...
    public static void main(String[] args) {
        GlossaryItem1302204057.ReadJSON();
    }
}