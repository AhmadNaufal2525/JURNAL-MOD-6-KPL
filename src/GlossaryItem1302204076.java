...
public class GlossaryItem1302204076 {
    public static void ReadJSON() {
        try {
            Object obj = new JSONParser().parse(new FileReader("/Users/afiffajarrayhan/Documents/Konstruksi Perangkat Lunak/praktikum MOD6/JURNAL-MOD-6-KPL/src/jurnal6_3_1302204076.json"));
    ...
    public static void main(String[] args) {
        GlossaryItem1302204076.ReadJSON();
    }
}
